        ...
        <div>
            <section className="bg-white">
                <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
                    <div className="mx-auto max-w-3xl text-center">
                        <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl">Résultats du BlindTest</h1>
                        <p className="text-3xl font-bold text-gray-900 sm:text-4xl">Votre score est de {score} sur {userAnswers.length * 2}</p>
                    </div>
                </div>
            </section>
                ...
                <div key={index}>
                    <div>
                        <section className="bg-white">
                            <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
                                <div className="mx-auto max-w-3xl text-center">
                                    <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">Question {answer.question + 1}</h2>
                                </div>
            ...
            <div className='w-full flex justify-center mb-10'>
                ...
                >
                    ...
                    <span className="text-sm font-medium transition-all group-hover:ms-4 "> Retour à l'accueil </span>
                </button>
            </div>
        </div>
    );
